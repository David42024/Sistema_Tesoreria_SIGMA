    ...
    <div class="col-12 col-lg-8">
        <div class="card">
            <div class="card-body">
                ...
                <div style="text-align: center; padding: 3rem 2rem; background: #00C1A2; border-radius: 15px 15px 0 0; margin: -2rem -2rem 2rem -2rem;">
                    <img src="https://marketingperu.beglobal.biz/wp-content/uploads/2024/09/logo-plin-fondo-transparente.png" alt="Plin" style="height: 150px; object-fit: contain; margin-bottom: 1.5rem;">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-text">
                                ...
                                @if(isset($montoPagado) && $montoPagado > 0)
                                    Saldo pendiente: <strong>S/ {{ number_format($saldoPendiente, 2) }}</strong>
                                    <br><small class="text-muted">Monto original: S/ {{ number_format($orden->monto_total, 2) }} | Pagado: S/ {{ number_format($montoPagado, 2) }}</small>
                                @else
...
@section('scripts')
<script>
    const montoMax = {{ $saldoPendiente ?? $orden->monto_total }};
