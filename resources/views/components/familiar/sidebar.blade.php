...
@section('opciones')
    ...
    @if($alumno)
        ...
        <li class="mb-4" :class="sidebarToggle ? 'lg:px-0' : 'px-4'">
            ...
            <div class="group relative bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-900 rounded-xl p-4 border-2 border-blue-200 dark:border-gray-600 shadow-md hover:shadow-xl transition-all duration-300"
                ...
                <div class="relative">
                    ...
                    <div class="flex justify-center mb-3">
                        <div class="relative">
                            <div class="w-20 h-20 rounded-full bg-gradient-to-br from-blue-200 to-indigo-200 dark:from-gray-700 dark:to-gray-800 flex items-center justify-center overflow-hidden ring-4 ring-white dark:ring-gray-800 shadow-lg transition-all duration-300 hover:scale-105">
                                @if($alumno->foto)
                            ...
                            <div class="absolute bottom-0 right-0 w-5 h-5 bg-green-500 rounded-full border-3 border-white dark:border-gray-800 shadow-md"></div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="space-y-2 mb-3">
                            ...
                            <div class="flex items-center justify-between bg-white/60 dark:bg-gray-800/60 rounded-lg px-3 py-1.5">
                                ...
                                <span class="text-xs font-semibold text-gray-800 dark:text-white">{{ $alumno->codigo_educando ?? 'N/A' }}</span>
                            </div>

                            {{-- Grado --}}
                            @php
                                $matriculaActiva = $alumno->matriculas()->where('estado', true)->orderBy('id_periodo_academico', 'desc')->first();
                            @endphp
                            <div class="flex items-center justify-between bg-white/60 dark:bg-gray-800/60 rounded-lg px-3 py-1.5">
                                <span class="text-xs text-gray-500 dark:text-gray-400 flex items-center gap-1.5">
                                    <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <span class="text-xs font-semibold text-gray-800 dark:text-white">{{ $matriculaActiva?->grado?->nombre_grado ?? 'N/A' }}</span>
                            </div>
            ...
            <a href="{{ route('familiar_dato_view') }}"
               class="hidden menu-item group menu-item-inactive"
               :class="sidebarToggle ? 'lg:flex' : ''"
               title="Ver información del estudiante">
                <svg class="menu-item-icon-inactive" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M12 4C9.79086 4 8 5.79086 8 8C8 10.2091 9.79086 12 12 12C14.2091 12 16 10.2091 16 8C16 5.79086 14.2091 4 12 4Z" stroke="currentColor" stroke-width="1.5"/>
